...
export { AuthGate };
//TODO Definition
export var withAuthGate = function (_a) {
    var sdk = _a.sdk, _b = _a.ensure, ensure = _b === void 0 ? false : _b;
    return function (Cmp) {
        var WrappedCmp = function (props) { return (React.createElement(AuthGate, { sdk: sdk, ensure: ensure }, function (renderProps) { return React.createElement(Cmp, __assign({}, props, renderProps)); })); };
